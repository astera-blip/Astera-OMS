...
- [ ] **Step 3: Implement the minimal transaction-safe PATCH route**
...
- [ ] **Step 3: Implement the inline form**
...
- [ ] **Step 4: Run focused board tests to verify GREEN**
...
- [ ] **Step 2: Run the focused navigation tests to verify RED**
...
- [ ] **Step 3: Implement the role-specific landing behavior**

Use the App Router redirect helper for Owner only, remove the Owner `/workspace` navigation entry while retaining it for Partner/Helper, and keep existing Owner/Partner/Helper route guards. Do not remove `/workspace` itself for Helper.

- [ ] **Step 4: Run focused navigation tests to verify GREEN**
...
- [ ] **Step 3: Run payment and workspace emulator acceptance**
